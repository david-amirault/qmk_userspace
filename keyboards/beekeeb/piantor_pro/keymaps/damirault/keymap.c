...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LHS] = LAYOUT_split_3x6_3(
        _______,    XXXXXXX,    MO(NUM),    MO(NMS),    MO(CMD),    MO(CDS),                            S(KC_B),    S(KC_F),    S(KC_O),    S(KC_U),    S(KC_J),    _______,
    ...
    [NUM] = LAYOUT_split_3x6_3(
        _______,    XXXXXXX,    MO(NUM),    MO(NMS),    MO(CMD),    MO(CDS),                            XXXXXXX,    KC_8,       KC_9,       KC_0,       XXXXXXX,    _______,
        _______,    XXXXXXX,    MO(NUM),    MO(NMS),    MO(CMD),    MO(CDS),                            KC_QUOT,    KC_1,       KC_2,       KC_3,       KC_4,       _______,
    ...
    [NMS] = LAYOUT_split_3x6_3(
        _______,    XXXXXXX,    MO(NUM),    MO(NMS),    MO(CMD),    MO(CDS),                            XXXXXXX,    S(KC_8),    S(KC_9),    S(KC_0),    XXXXXXX,    _______,
        _______,    XXXXXXX,    MO(NUM),    MO(NMS),    MO(CMD),    MO(CDS),                            S(KC_QUOT), S(KC_1),    S(KC_2),    S(KC_3),    S(KC_4),    _______,
    ...
    [CMD] = LAYOUT_split_3x6_3(
        _______,    XXXXXXX,    MO(NUM),    MO(NMS),    MO(CMD),    MO(CDS),                            XXXXXXX,    KC_SCLN,    KC_MINS,    KC_DOT,     XXXXXXX,    _______,
        _______,    XXXXXXX,    MO(NUM),    MO(NMS),    MO(CMD),    MO(CDS),                            KM_NB,      KM_NF,      KC_VOLD,    KC_VOLU,    KC_MUTE,    _______,
        _______,    XXXXXXX,    KC_LCTL,    KC_LALT,    KC_LGUI,    XXXXXXX,                            XXXXXXX,    KM_PH,      KC_BRID,    KC_BRIU,    XXXXXXX,    _______,
                                                        _______,    _______,    _______,    KC_ESC,     KC_BSPC,    KC_ENT
    ),

    [CDS] = LAYOUT_split_3x6_3(
        _______,    QK_BOOT,    MO(NUM),    MO(NMS),    MO(CMD),    MO(CDS),                            XXXXXXX,    S(KC_SCLN), S(KC_MINS), S(KC_DOT),  XXXXXXX,    _______,
        _______,    XXXXXXX,    MO(NUM),    MO(NMS),    MO(CMD),    MO(CDS),                            KM_NB,      KM_NF,      S(KC_VOLD), S(KC_VOLU), S(KC_MUTE), _______,
        _______,    XXXXXXX,    KC_LCTL,    KC_LALT,    KC_LGUI,    XXXXXXX,                            XXXXXXX,    KM_PH,      S(KC_BRID), S(KC_BRIU), XXXXXXX,    _______,
                                                        _______,    _______,    _______,    S(KC_ESC),  S(KC_BSPC), S(KC_ENT)
    ),

    [RHS] = LAYOUT_split_3x6_3(
        _______,    S(KC_Q),    S(KC_L),    S(KC_Y),    S(KC_G),    S(KC_K),                            MO(NVS),    MO(NAV),    MO(SMS),    MO(SYM),    XXXXXXX,    _______,
    ...
    [SYM] = LAYOUT_split_3x6_3(
        _______,    XXXXXXX,    KC_LBRC,    KC_RBRC,    KC_QUOT,    XXXXXXX,                            MO(NVS),    MO(NAV),    MO(SMS),    MO(SYM),    XXXXXXX,    _______,
        _______,    KC_BSLS,    KC_GRV,     KC_MINS,    KC_SCLN,    CAPSWRD,                            MO(NVS),    MO(NAV),    MO(SMS),    MO(SYM),    XXXXXXX,    _______,
    ...
    [SMS] = LAYOUT_split_3x6_3(
        _______,    XXXXXXX,    S(KC_LBRC), S(KC_RBRC), S(KC_QUOT), XXXXXXX,                            MO(NVS),    MO(NAV),    MO(SMS),    MO(SYM),    XXXXXXX,    _______,
        _______,    S(KC_BSLS), S(KC_GRV),  S(KC_MINS), S(KC_SCLN), KC_CAPS,                            MO(NVS),    MO(NAV),    MO(SMS),    MO(SYM),    XXXXXXX,    _______,
    ...
    [NAV] = LAYOUT_split_3x6_3(
        _______,    XXXXXXX,    KC_HOME,    KC_END,     KC_Q,       XXXXXXX,                            MO(NVS),    MO(NAV),    MO(SMS),    MO(SYM),    XXXXXXX,    _______,
        _______,    KC_LEFT,    KC_UP,      KC_DOWN,    KC_RGHT,    KC_INS,                             MO(NVS),    MO(NAV),    MO(SMS),    MO(SYM),    XXXXXXX,    _______,
        _______,    XXXXXXX,    KC_PGUP,    KC_PGDN,    KC_DEL,     XXXXXXX,                            XXXXXXX,    KC_LGUI,    KC_LALT,    KC_LCTL,    XXXXXXX,    _______,
                                                        KC_TAB,     KC_SPC,     KC_ESC,     _______,    _______,    _______
    ),

    [NVS] = LAYOUT_split_3x6_3(
        _______,    XXXXXXX,    S(KC_HOME), S(KC_END),  S(KC_Q),    XXXXXXX,                            MO(NVS),    MO(NAV),    MO(SMS),    MO(SYM),    XXXXXXX,    _______,
        _______,    S(KC_LEFT), S(KC_UP),   S(KC_DOWN), S(KC_RGHT), S(KC_INS),                          MO(NVS),    MO(NAV),    MO(SMS),    MO(SYM),    XXXXXXX,    _______,
